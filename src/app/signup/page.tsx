...
const Signup = () => {
  return (
    ...
    <div className="flex-col h-3/4 w-4/5 mt-14 ml-20 pt-12  sm:ml-28 md:ml-40 lg:basis-1/2">
        <div className="text-2xl font-normal bg-black mb-[30px] text-[rgb(231,233,234)] md:text-3xl xl:text-4xl">
          Create your account
        </div>
      ...
      <div className="hidden  lg:block basis-1/2 overflow-hidden">
        <Image src="/signup.png" alt="signup" width={700} height={200} className='mt-[70px] ml-[80px]'  />
